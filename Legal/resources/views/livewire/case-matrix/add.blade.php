                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div class="flex flex-col w-full">
                            ...
                            <input wire:model.defer='date_resolved' id="date_resolved" type="date" placeholder="Date Resolved" class="input input-bordered w-full input-md" />
                            @error('date_resolved')
                            <span class="text-red-500"> {{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex w-full gap-4">
                            <div class="flex font-semibold">
                                <input wire:model.defer='status' id="status" type="radio" id="Add On-going" name="radio-2" aria-label="On-going" value="On-going" class="btn btn-sm btn-wide" />
                            </div>
                            <div class="flex font-semibold">
                                <input wire:model.defer='status' id="status" type="radio" id="Add On-going" name="radio-2" aria-label="Resolved" value="Resolved" class="btn btn-sm btn-wide" />
                            </div>                                    
                        </div>
                        @error('status')
                            <span class="text-red-500"> {{$message}}</span>
            ...
            <div class="modal-box">
                ...
                <div class="modal-action">
                    <form method="dialog">
                        ...
                        <button wire:click.prevent="create" type="submit" class="btn btn-primary" onclick="add_confirm.close()" > YES</button>
                    </form>
                </div>
            </div>
            </dialog>
