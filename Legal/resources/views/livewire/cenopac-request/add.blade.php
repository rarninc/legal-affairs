                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div class="flex flex-row justify-between items-center">
                        ...
                        <div class="flex font-semibold">
                            <input name = "status" id="status" type="radio" id="Add Urgent" name="radio-2" aria-label="Urgent" value="Urgent" class="btn btn-sm w-40" />
                        </div>
                        <div class="flex font-semibold">
                            <input name = "status" id="status" type="radio" id="Add Nonurgent" name="radio-2" aria-label="Nonurgent" value="Nonurgent" class="btn btn-sm w-40" />
                        </div>                                    
                    </div>
                </div>
            </div>
                ...
                <div class="modal-action">
                    <form method="dialog">
                        ...
                        <button wire:click.prevent="create" 
                                ...
                                type="submit" class="btn btn-primary" onclick="add_request_confirm.close()" > YES</button>
                    </form>
                </div>
            </div>
            </dialog>
